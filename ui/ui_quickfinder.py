...
class Ui_quickFinder(object):
    def setupUi(self, quickFinder):
        ...
        self.progressWidget = QtWidgets.QWidget(self.frame)
        self.progressWidget.setObjectName(_fromUtf8("progressWidget"))
        self.processLayout = QtWidgets.QGridLayout(self.progressWidget)
        ...
        self.operatorBox.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        ...
        self.layerWidget = QtWidgets.QWidget(self.frame)
        self.layerWidget.setObjectName(_fromUtf8("layerWidget"))
        self.layerLayout = QtWidgets.QGridLayout(self.layerWidget)
        self.layerLayout.setMargin(0)
        self.layerLayout.setObjectName(_fromUtf8("layerLayout"))
        self.layerCombo = QtWidgets.QComboBox(self.layerWidget)
        ...
        self.label = QtWidgets.QLabel(self.layerWidget)
        ...
        self.fieldCombo = QtWidgets.QComboBox(self.fieldWidget)
        ...
        self.fieldCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.fieldCombo.setObjectName(_fromUtf8("fieldCombo"))
        self.fieldLayout.addWidget(self.fieldCombo, 0, 1, 1, 1)
        self.label_ = QtWidgets.QLabel(self.fieldWidget)
